...
for dataset in data_dir_list:
 ...
 #aalocate the encorded labels to respective images   
...
resnet_model = Model(vgg.input, output)
...
#define the model with the SofMax classifier and Categorical crosentropy
...
#plot history 
    ...
    history=model.fit(x_train, y_train,epochs=30, batch_size=60,verbose=1)
...
#respective lables of test images
label[0:81]=0 #81
label[81:159]=1 #78
label[159:237]=2 #78
label[237:381]=3 #144
