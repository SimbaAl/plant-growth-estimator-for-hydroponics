...
#layer_num = len(vgg_model.layers)
...
#define the full model with fully connected layers and SoftMax layers
...
#get the test images and allocate labels to it
test_data_path = 'radish_test/test'
test_data_dir_list = os.listdir(data_path)

#aarange the images in order 
from natsort import natsorted, ns
...
for dataset in test_data_dir_list:
    ...
    for img in img_list:
      ...
      input_img=cv2.resize(input_img,(2240,224))
...
#print predctions and confusion matrices, and classification reports
print(prediction)
